...
# stb
rez-env arras4_node -c "arras4_node -l 5 --consul-host q_con_jose_configsvc.db.gld.dreamworks.net  --athena-env prod --use-color 0 --exclusive-user --no-local-rez --fork-router" |& tee /tmp/arras/node_service.log
# uns
