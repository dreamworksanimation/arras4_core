...
rez-env arras4_node -c "arras4_node --use-cgroups --enforce-cpu -l 5 --consul-host d_con_jose_configsvc.db.gld.dreamworks.net  --athena-env dev --use-color 0 --exclusive-user --no-local-rez" |& tee /tmp/arras/node_service.log
